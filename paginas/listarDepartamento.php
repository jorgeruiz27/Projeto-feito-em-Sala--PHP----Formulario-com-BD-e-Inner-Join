                ...
                <tbody>
                    ...
                    if ($qtd > 0) {
                        while ($row = $res->fetch_object()) {
                            ...
                            echo "<td>
                                <button onclick=\"location.href='editarDepartamento.php?&id=" . $row->idDepartamento . "';\" class='btn btn-success'>Editar</button> 
                                <button onclick=\"if(confirm('Tem certeza que deseja excluir?')){location.href='../sistema/cadDepartamento.php?&acao=excluir&id=" . $row->idDepartamento . "';}else{false;}\" class='btn btn-danger'>Excluir</button> 
                            </td>";
                        }
                    } else {
